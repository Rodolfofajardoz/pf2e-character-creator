...
per the table below, not patches continuing the `0.6.x` line — caught
after they'd already shipped, left as-is rather than rewriting published
tags/releases. Corrected starting with `v0.7.0` (custom PDF printing).
